...
- Sin *barrel files* (`index.ts` que reexporta todo): importa cada módulo desde su archivo real — infla el bundle y complica el tree-shaking.
...
## 4. Rendimiento (React Native / Expo)
...
| Crítico | Sin *barrel imports*: importa directo del archivo fuente. |
...
## 6. Agentes disponibles en este repo
